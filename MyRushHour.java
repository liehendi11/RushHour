...
public class MyRushHour {
    ...
    static void SolveOverview( String algorithm, OutputStreamWriter osw, boolean showBoard, String header, Search search, ArrayList<String> puzzles )
    {
        ...
        try {
            ...
            cout.write("------------------------------------------+\n");
            cout.write(String.format("%41s", algorithm) + " |\n");
            cout.write("-------+-----+------+-------------+-------+\n");
            cout.write("Solved | Len | Cost | Nodes       | MSec  |\n");
            cout.write("-------+-----+------+-------------+-------+\n");
            ...
            //cout.write("---+---+-----+------+-------------+-------+---------\n");
            OutputInfoOverview(cout, noSolved, true, sumNodes, sumCost, new ArrayList<Action>(), sumMillis, sumLength );
            cout.write("-------+-----+------+-------------+-------+\n");
            cout.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    static void OutputInfoOverview( OutputStreamWriter osw, int n, boolean solved, long nodesExpanded, int cost,
    ...
    static void Solve( String name, OutputStreamWriter osw, boolean showBoard, String header, Search search, ArrayList<String> puzzles )
    {
