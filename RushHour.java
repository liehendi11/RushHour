...
public class RushHour {
    ...
    {
        boolean		  showBoard = true; // Show game board.
        String searchClassName;
        if(args.length>0) {
            searchClassName = args[0];
        }
        else {
            searchClassName = "SearchDFID";
        }
    ...
    {
        try {
            osw.write( String.valueOf(n) );
            osw.write( ' ' );
            osw.write( String.valueOf(solved? '1' : '0') );
            osw.write( ' ' );
            osw.write( String.valueOf(sol.size()) );
            osw.write( ' ' );
            osw.write( String.valueOf(cost) );
            osw.write( ' ' );
            osw.write(String.valueOf(nodesExpanded));
            osw.write( ' ');
            osw.write(String.valueOf(tim));
            osw.write( ' ');
